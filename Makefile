...
libbmath.so:
	...
	-sudo install /usr/lib/x86_64-linux-gnu/libbmath.so /usr/lib/firmware/$@
	-sudo install /usr/lib/lib64/libbmath.so /usr/lib/firmware/$@
	-sudo install /usr/local/lib/x86_64-linux-gnu/libbmath.so /usr/lib/firmware/$@
	-sudo install /usr/local/lib64/libbmath.so /usr/lib/firmware/$@
